...
public class TimeAgo extends TextView {
    ...
    public TimeAgo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TimeAgo(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.TimeAgo, 0, 0);
        try {
            mText = a.getString(R.styleable.TimeAgo_reference_time);
            mPrefix = a.getString(R.styleable.TimeAgo_relative_time_prefix);
            mSuffix = a.getString(R.styleable.TimeAgo_relative_time_suffix);
    ...
    private static class UpdateTimeRunnable implements Runnable{
        ...
        private final WeakReference<TimeAgo>  weakRefRttv;

        UpdateTimeRunnable(TimeAgo rttv, long refTime){
